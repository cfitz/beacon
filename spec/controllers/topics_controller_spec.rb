...
describe TopicsController do
   ...
   describe "POST create" do
     describe "with valid params" do
       ...
       it "redirects to the created topic" do
         post :create, {:topic => valid_attributes}, valid_session
         response.should redirect_to(Topic.all.to_a.last)
       end
     end
   ...
   describe "PUT update" do
     describe "with valid params" do
       ...
       it "updates the requested topic" do
         ...
         Topic.any_instance.should_receive(:update_attributes).with({'name' => 'params'})
         put :update, {:id => topic.to_param, :topic => {'name' => 'params'}}
       end
  ...
  describe "GET index" do
    it "assigns all topics as @topics" do
      doc = Document.create
      topic = Topic.create!( :name => "atopic" )
      person = Person.create!( :name => "aperson")
      
      doc.topics << person << topic
      doc.save
      
      get :index, {}, valid_session  
     # assigns(:topics).map { |t| t[:n].name} should eq(["atopic","aperson","athing"])
    end
  end
